...
const cycle = L.tileLayer('//{s}.tile.thunderforest.com/cycle/{z}/{x}/{y}.png', thunderAttr);
    ...
    children: [
        /* start aiports from http://www.partow.net/miscellaneous/airportdatabase/#Download */
        {
            ...
            children: [
                ...
                { label: 'FUERSTENFELDBRUCK - FEL', layer: L.marker([48.206, 11.267]) },
                ...
                { label: 'MUENSTER/OSNABRUECK - FMO', layer: L.marker([52.134, 7.685]) },
                ...
                { label: 'OBERPFAFFENHOFEN - OBF', layer: L.marker([48.081, 11.283]) },
        ...
        },
        {
            ...
            children: [
                ...
                { label: 'SANTA CRUZ DE LA PALMA - SPC', layer: L.marker([28.626, -17.756]) },
        ...
        },
        {
            ...
            children: [
                ...
                { label: 'AUBENAS-VALS-LANAS - OBS', layer: L.marker([44.544, 4.372]) },
                ...
                { label: 'BIARRITZ-BAYONNE - BIQ', layer: L.marker([43.468, -1.523]) },
                ...
                { label: 'LA ROCHE-SUR-YON - EDM', layer: L.marker([46.702, -1.379]) },
                ...
                { label: 'ST.-BRIEUC ARMOR - SBK', layer: L.marker([48.538, -2.854]) },
                ...
                { label: 'TOUSSOUS-LE-NOBLE - TNF', layer: L.marker([48.752, 2.106]) },
